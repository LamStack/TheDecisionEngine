  ...
  return (
    <div className="space-y-6">
      ...
      <article className="max-w-3xl space-y-4 rounded-xl border border-border bg-panel p-6 text-sm leading-relaxed text-muted">
        <p>
          Decision layers become the trust primitive of agentic systems &mdash; not a feature bolted onto an agent,
        ...
        <p>
          ...
          importing a decision layer the way they import an auth provider &mdash; same shape (propose action +
        ...
        <p>
          ...
          customer after an incident. Structured evidence trails &mdash; what evidence, what was missing, the
          reversibility calculus &mdash; become the expected output, not a nice-to-have.
        </p>
        <p>
          ...
          off from agents entirely &mdash; not because models got smarter, but because orgs stop trusting confidence
        ...
        <p>
          ...
          recursively. That moves the trust problem up one level without solving it &mdash; still a black box, just
